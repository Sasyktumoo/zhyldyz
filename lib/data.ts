...
export const benefits: Benefit[] = [
  {
    id: 'benefit-1',
    icon: 'Target',
    title: 'Exam & Migration Track (DELF/DALF/TEF)',
    description: 'Clear roadmap to target scores with examiner-level guidance.',
    how: 'Examiner-certified training with focused drills on weak areas and mock exam conditions.',
    outcome: 'Hit your DELF/DALF/TEF targets with zero guesswork.',
  },
  {
    id: 'benefit-2',
    icon: 'TrendingUp',
    title: 'Career Track (Professional French)',
  ...
  },
  {
    id: 'benefit-3',
    icon: 'MessageCircle',
    title: 'Foundations Track (A0 → B1 Fast-Track)',
    description: 'Speak from lesson one; measurable gains every two weeks.',
    how: '70% learner talk-time, micro-drills for your error patterns, and pronunciation work baked in.',
...
export const testimonials: Testimonial[] = [
  {
    ...
    headline: 'A2 → B2 in four months (exam + speaking)',
    text: 'Started at A2; four months later I can argue my point at B2. The talk-first lessons and weekly writing briefs finally made French stick.',
    rating: 5,
  },
  {
    id: 'testimonial-2',
